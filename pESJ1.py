...
def experiment_1(sf, iters):
  ...
  for i in range(iters):
    ...
    C_a = base.Encrypt(table_a, encoded_attrs_a, join_attrs_a, pk_attr_a, main_basis_a, aux_basis_t, aux_basis_d, t, p, key)
    time2 = time.perf_counter()
...
if __name__ == "__main__":
    ...
    scale_factors = ["0.2", "0.4", "0.6", "0.8", "1"]
