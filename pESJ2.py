...
def experiment_1(join_attrs_a, iters):
  print("--------------------------- #|J|="+str(len(join_attrs_a)))
  ...
  for i in range(iters):
    ...
    C_a = base.Encrypt(table_a, encoded_attrs_a, join_attrs_a, pk_attr_a, main_basis_a, aux_basis_t, aux_basis_d, t,
                  p, key)
    time2 = time.perf_counter()
    enc_time.append(time2-time1)
    enc_timeper.append((time2 - time1)/l_a)

    table_a_Y_att = join_attrs_a + encoded_attrs_a
    print("table_a_Y_att",table_a_Y_att)
    ...
    # aux_basis_t = base.derive_aux_basis(key_t, bit_length, p)
    # aux_basis_d = base.derive_aux_basis(key_d, AUX_DIM, p)
    tk_a = base.TokenGen(join_attrs_a, encoded_attrs_a, x_a, main_basis_a, aux_basis_t, aux_basis_d, t, p,
...
if __name__ == "__main__":
    ...
    join_atts = [["PARTKEY"], ["PARTKEY","NAME"], ["PARTKEY","NAME","MFGR"], ["PARTKEY","NAME","MFGR","BRAND"], ["PARTKEY","NAME","MFGR","BRAND","TYPE"]]
